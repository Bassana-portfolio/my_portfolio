              ...
              <div className="row justify-content-start pb-3">
                ...
                <div className="col-md-12">
                  <div className="my-interest d-lg-flex w-100">
                    <InterestItem icon="flaticon-listening" text="Music" />
                    <InterestItem icon="flaticon-suitcases" text="Travel" />
                    <InterestItem icon="flaticon-video-player" text="Movie" />
                    <InterestItem icon="flaticon-football" text="Sports" />
                  </div>
                </div>
              </div>
            </div>
...
// Composant séparé pour les intérêts
function InterestItem({ icon, text }: { icon: string; text: string }) {
  return (
